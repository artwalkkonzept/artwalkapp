...
- POST `api/artwalk/signup` for User Registration
- POST `api/artwalk/signin` for User Login
...
> [React + Spring Boot](https://bezkoder.com/spring-boot-react-jwt-uth/)
...
## Note:
Open `src/services/artwalk-header.js` and modify `return` statement for appropriate back-end (found in the tutorial).
