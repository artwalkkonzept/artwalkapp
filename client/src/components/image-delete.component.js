...
import DeleteService from "../services/file-delete.service";
//import ImageUploader from "react-images-upload";



export default class DeleteImages extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    DeleteService.getFiles().then((response) => {
      this.setState({
        imageInfos: response.data,
      });
    });
  ...
  delete() {
    ...
    DeleteService.delete(this.state.currentFile, (event) => {
      this.setState({
