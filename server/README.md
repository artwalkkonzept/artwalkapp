...
Associations:
> [MongoDB One-to-One relationship trtwalk with Mongoose examples](https://bezkoder.com/mongoose-one-to-one-relationship-example/)

> [MongoDB One-to-Many Relationship trtwalk with Mongoose examples](https://bezkoder.com/mongoose-one-to-many-relationship/)
